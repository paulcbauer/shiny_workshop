...
-   Design the goals and objectives of a Shiny app
-   Learn to prepare data, structure and tools before starting to code
-   Learn about data storage for Shiny apps
...
pacman::p_load(
	shiny,
	htmltools,
	bs4Dash, # dashboards in Shiny
	fresh, # Shiny app theming
	waiter, # Shiny spinners
	shinyWidgets, # pretty UI widgets
	Guerry, # dataset
	sf, # spatial data
	tidyr, # clean data
	dplyr, # wrangle data
	RColorBrewer, # color palettes
	viridis, # colorblind palettes
	leaflet, # interactive maps
	plotly, # interactive plots
	jsonlite, # read JSON files
	ggplot2, # plotting
	GGally, # pair plots
	datawizard, # wrangle data
