...
-   Shinylive is one of Posit's new things
-   An application deployed with Shinylive does not need a server: It is a static website!
-   This is possible primarily due to developments in what is called **WebAssembly (wasm)**

## WebAssembly

-   WebAssembly is a browser language (like JavaScript) that is very close to the hardware
-   Wasm created a hype in the R community because it is able to run programming languages directly on the web
-   

## Limitations

-   Nothing good ever comes easy
-   Shinylive comes with a number of limitations:
    -   Can be quite slow on startup
    -   Not all R (or Python) packages are available
        -   R packages need to be built for WebAssembly
    ...
    -   Some R features do not work (e.g. parallelization, database connections, or system commands)
