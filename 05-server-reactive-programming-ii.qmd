...
Reactives (`reactive()`) wrapped up:
  ...
  - They are evaluated **lazily**, i.e. they only run if they are forced to.
...
- But they also carry many important differences:
  ...
  - They are forgetful, i.e. they do not remember their previous action.
