...
```{r, eval=FALSE, file="shinyapps/example/states/05-observe.R"}
#| code-fold: true
...
```{r, eval=FALSE, file="shinyapps/example/states/05-update.R"}
#| code-fold: true
...
```{r, eval=FALSE, file="shinyapps/example/states/05-req.R"}
#| code-fold: true
#| code-summary: "Complete code (important lines are highlighted)"
