...
```{r, eval=FALSE, file="shinyapps/example/app.R"}
#| code-fold: true
#| code-summary: "Complete code for the ESS app"
```
:::
...
#| code-fold: true
#| code-summary: "Solution for exercise 2.5 (important lines are highlighted)"
#| source-line-numbers: "92-96,209-240"

```
:::

### Proxies and plot events
...
```{r, eval=FALSE, file="shinyapps/example/06-exercise3_2.R"}
#| code-fold: true
#| code-summary: "Code for exercise 3.2"
...
```{r, eval=FALSE, file="shinyapps/example/06-exercise3_2_solution.R"}
#| code-fold: true
#| code-summary: "Solution for exercise 3.2 (important line are highlighted)"
...
```{r, eval=FALSE, file="shinyapps/example/06-exercise3_3_solution.R"}
#| code-fold: true
#| code-summary: "Solution for exercise 3.3 (important line are highlighted)"
#| source-line-numbers: "114-127"
...
So far, we have only talked about plot events in Leaflet. Taking the code below, implement an observer that prints the current plot coordinates every time a user hovers over the plot elements. Use plotly's [`event_data()`](https://rdrr.io/cran/plotly/man/event_data.html) function. What kinds of information are displayed?

```{r, eval=FALSE, file="shinyapps/example/06-exercise3_4.R"}
#| code-fold: true
#| code-summary: "Code for exercise 3.4"
```
:::
...
```{r, eval=FALSE, file="shinyapps/example/06-exercise3_4_solution.R"}
#| code-fold: true
#| code-summary: "Solution for exercise 3.4 (important line are highlighted)"
#| source-line-numbers: "34-37"
