...
-   We already created another tab item called `tab_intro`, so we can tell where our new tab item goes:
...
dashboardPage(
  ...
  sidebar = dashboardSidebar(                             # <1>
    ...
    sidebarMenu(                                          # <1>
      id = "sidebarMenu",                                 # <1>
      menuItem(tabName = "tab_intro", text = "Introduction"), # <1>
      menuItem(tabName = "tab_model", text = "Model data")    # <1>
    )
  ),
