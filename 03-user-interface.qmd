...
#### Exercise: UI
1. Create a new dashboard using the code in Section XXXX. 
...
4. Build a UI that contains the image (stored in the `www` folder or taken from the website) in the body of the dashboar.
...
```{r exercise-3-1, echo=FALSE, eval=FALSE, include=TRUE}
