...
### dashboardPage (1)  {#sec-dashboardPage}
...
### dashboardPage (2): Adding items and tabs {#sec-dashboardPage2}
...
ui <- dashboardPage( # <1>
  ...
  header = dashboardHeader( # <2>
    ...
    a(  # <4>
      ...
      img(src = "https://www.gesis.org/typo3conf/ext/gesis_web_ext/Resources/Public/webpack/dist/img/logo_gesis_en.svg", style = "height: 1.8em;")
    )
  ),
...
ui <- dashboardPage(
  ...
  ### Header ----
  header = dashboardHeader("The ESS shiny app"),
