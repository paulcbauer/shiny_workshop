...
* How to
  + Download the file for the reactive graph [here](https://drive.google.com/file/d/13W9CmQd2G86vyAxnrNZ7PZ7FYubWwGZD/view?usp=sharing)
  + Go to the website [draw.io](https://draw.io)/[app.diagrams.net/](https://app.diagrams.net/)
...
# Generate synthetic data
  ...
  # synthetic_data is a list

# Extract the new synthetic data and store in a datafame
# iris_synthetic contains the synthetica data that you can share (with us)
  iris_synthetic <- synthetic_data$syn

# Save the data
  write_csv(iris_synthetic, "data_synthetic.csv")
```
