...
### Shiny extensions for theming

-   Shiny has some really cool extensions for amping up your UI, each of which we will address:
...
Experiment with `bs_theme_preview()` to learn about the different arguments to `bs_theme()`. When you find a pretty theme, re-create the the theme programmatically using `bs_theme()`
:::
...
-   [`fresh`](https://cran.r-project.org/web/packages/fresh/) is an R package that can be used to theme, besides classic Shiny, dashboards like [`shinydashboard`](https://rstudio.github.io/shinydashboard/) and [`bs4Dash`](https://rinterface.github.io/bs4Dash/)

-   [`bs4Dash`](https://cran.r-project.org/web/packages/bs4Dash/) can easily be themed using the [`fresh`](https://cran.r-project.org/web/packages/fresh/) package
