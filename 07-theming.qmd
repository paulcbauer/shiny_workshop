...
![The Inspect tool in Firefox](resources/inspect.png){alt="The Inspect tool in Firefox"}
...
-   `fresh` is an R package that can be used to theme, besides classic Shiny, dashboards like [`shinydashboard`](https://rstudio.github.io/shinydashboard/) and [`bs4Dash`](https://rinterface.github.io/bs4Dash/)
...
| Proprerty          | Description                                      | Example values                |
|--------------------|--------------------------------------------------|-------------------------------|
...
| `z-index`          | Sets the overlapping order                       | Ranking, e.g., -1, 0, 1, 1000 |
