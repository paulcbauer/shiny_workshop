...
```{r, eval=FALSE, file="shinyapps/example/states/06-leaflet.R"}
#| code-fold: true
#| code-summary: "Complete code (important lines are highlighted)"
...
```{r, eval=FALSE, file="shinyapps/example/states/06-exercise1.R"}
#| code-fold: true
#| code-summary: "Complete code (important lines are highlighted)"
...
```{r, eval=FALSE, file="shinyapps/example/states/06-exercise2.R"}
#| code-fold: true
#| code-summary: "Complete code (important lines are highlighted)"
...
```{r, eval=FALSE, file="shinyapps/example/states/06-exercise3_1.R"}
#| code-fold: true
...
```{r, eval=FALSE, file="shinyapps/example/states/06-exercise3_1_solution.R"}
#| code-fold: true
...
```{r, eval=FALSE, file="shinyapps/example/states/06-exercise3_2.R"}
#| code-fold: true
...
```{r, eval=FALSE, file="shinyapps/example/states/06-exercise4_highcharts.R"}
#| code-fold: true
#| code-summary: "Complete code (important lines are highlighted)"
...
```{r, eval=FALSE, file="shinyapps/example/states/06-exercise4_apexcharts.R"}
#| code-fold: true
#| code-summary: "Complete code (important lines are highlighted)"
