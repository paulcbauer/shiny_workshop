...
- Part is almost exclusively based on @Bertini2017-jq.
...
8. **Sharing and Publishing**: Shiny apps can be easily published and shared, either through RStudio's Shiny server, Shinyapps.io, or embedding in R Markdown documents or websites (shinylive!).
...
- In the workshop we will built the Shiny app shown in @fig-app-image together. Please [explore this app here - UPDATE LINK](https://paulbauer.shinyapps.io/guerry_dashboard/) (5-10 minutes) and answer the following questions:
...
```{r chunk-2, eval=FALSE, file="shinyapps/guerry/states_paul/app_tab_tabulate.R"}
#| code-fold: true
