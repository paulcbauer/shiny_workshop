...
- **Representation (Data/Model &rarr; Eyes)**
  ...
  - "deciding **what to visualize** is often equally, if not more, important, than deciding **how to visualize** it" [@Bertini2017-jq]
...
![(Source: Original image)](resources/02-guerrydashboard.png){#fig-guerrydashboard}
