---
title: "Mapping and advanced visualization"
---
...
-   The geodetic specifics are mostly not necessary, but it's always good to know a basic distinction
    ...
    -   **Geodetic CRS** use angular units (degrees) because they are based on a spheroid -- usually good for global or national scale visualizations
...
| Name                               | EPSG code | Area    | Geodetic? |
|------------------------------------|-----------|---------|-----------|
| World Geodetic System 1984 (WGS84) | 4326      | World   | Yes       |
| UTM zone 32N                       | 25832     | Germany | No        |
| LAEA Europe                        | 3035      | Europe  | No        |
...
`guerry` currently consists of multi polygons. How can we convert these polygons to point geometries? Explore the function reference of the sf package and find functions (multiple answers possible) that can convert polygons to points in some way.
:::
